...
use App\Http\Controllers\Api\PurchaseHeadController;
...
Route::prefix('api')->group(function () {
    ...
    Route::post('/purchase-heads', [PurchaseHeadController::class, 'store']);
    Route::get('/purchase-heads', [PurchaseHeadController::class, 'index']);
